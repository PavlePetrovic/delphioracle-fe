...
import { shuffledQuestions, shuffledSynastryQuestions } from "../localChatData";
...
import { questionsArrayType, questionsCategoriesType } from "../types";
import {
                ...
                <div
                  ...
                  className={`group flex items-center justify-start gap-3 border p-4 ${
                    filter === data.category
                      ? "border-gold"
                      : "border-[#ffffff0f]"
                  } w-full cursor-pointer rounded-xl bg-main-grey transition-all`}
                >
                  <data.Icon
                    className={`${
                      filter === data.category ? "[&_path]:fill-gold" : ""
              ...
              questions?.map((data) => {
                return (
                  filter === data.category && (
                    <div
                      key={data.id}
                      className="group flex h-full min-h-[120px] w-full cursor-pointer flex-col items-start justify-between gap-2.5 rounded-2xl border border-[#ffffff0f] bg-main-grey p-4 hover:border-gold w888:min-h-[100px] w888:gap-[7px] w888:p-2.5"
                    ...
                    >
                      ...
                      <div className="mt-auto flex w-full items-center justify-between">
                        <div className="rounded-full bg-[#4f5864df] px-2.5 py-0.5 text-sm font-extralight text-white w888:px-2 w888:py-[1px] w888:text-[12px]">
                          {data.category}
                        </div>
