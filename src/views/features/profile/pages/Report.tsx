    ...
    <div className="flex flex-col items-center justify-center gap-3">
      ...
      <div className="relative h-[306px] w-[306px] rounded-full border-2 border-gold w888:h-[250px] w888:w-[250px] w480:h-[220px] w480:w-[220px]">
        <div className="absolute left-0 top-0 -ml-[53px] flex h-full w-full items-center justify-between gap-10 rounded-full w888:-ml-[42px] w888:gap-5 w480:-ml-[46px] w480:gap-2.5">
          <div className="flex min-w-[110px] cursor-pointer items-center justify-between rounded-3xl bg-[#0D101A] px-2 py-[5px] hover:border hover:border-gold w888:min-w-[95px]">
            <AscendentIco className="h-auto w-[24px] opacity-70" />
            <ZodiacSymbol
      ...
      <p className="mb-6 mt-6 w-[75%] text-center text-xs font-light text-[#f6faffc6] w888:w-full">
        Experimental Feature - Still Cooking
        <br />
        <br />
        This feature is still in the works. By getting credits, you're helping
        us make it a reality. Big thanks for the love and for being part of the
        magic - you're making it happen! ✨
        <br />
        <br />
        Mystically yours
        <br />
