...
import { getUserData } from "../reducer/chatBox.actions";
  ...
  const memoizedContent = useMemo(() => {
    return (
      <div className="mx-auto flex max-w-[620px] flex-col gap-16 w888:relative w888:z-10 w888:gap-10">
        ...
        <p className="bg-glass animate-pulse rounded-2xl px-8 py-5 text-center text-lg font-extralight text-[#FFFFFF7A] text-white w888:mx-3 w888:px-6 w888:py-4 w888:text-base">
